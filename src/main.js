...
class App {
    ...
    render() {
        ...
        this.tutorialManager.update(delta); // Update tutorial logic

        // Add tutorial group to gaze interactables if active
        if (this.tutorialManager.isActive && this.tutorialManager.group.visible) {
            interactables.push(this.tutorialManager.group);
        }
